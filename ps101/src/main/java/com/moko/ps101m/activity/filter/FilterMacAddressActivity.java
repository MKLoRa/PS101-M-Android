...
public class FilterMacAddressActivity extends BaseActivity {
                                ...
                                case KEY_FILTER_MAC_RULES:
                                    if (length > 0) {
                                        ...
                                        for (int i = 0, l = filterMacAddress.size(); i < l; i++) {
                                            ...
                                            View v = LayoutInflater.from(FilterMacAddressActivity.this).inflate(R.layout.item_mac_filter, mBind.llMacAddress, false);
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.item_mac_filter, mBind.llMacAddress, false);
        TextView title = v.findViewById(R.id.tv_mac_address_title);
