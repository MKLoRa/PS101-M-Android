...
import com.moko.ps101m.databinding.ActivityIndicatorSettingsBinding;
...
public class IndicatorSettingsActivity extends BaseActivity {
    private ActivityIndicatorSettingsBinding mBind;
    private boolean mReceiverTag = false;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = ActivityIndicatorSettingsBinding.inflate(getLayoutInflater());
