...
public class PS101FilterBXPTagIdActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_FILTER_BXP_TAG_RULES:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101FilterBXPTagIdActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
                                ...
                                case KEY_FILTER_BXP_TAG_RULES:
                                    if (length > 0) {
                                        ...
                                        for (int i = 0, l = filterTagId.size(); i < l; i++) {
                                            ...
                                            View v = LayoutInflater.from(PS101FilterBXPTagIdActivity.this).inflate(R.layout.ps101m_item_tag_id_filter, mBind.llTagId, false);
