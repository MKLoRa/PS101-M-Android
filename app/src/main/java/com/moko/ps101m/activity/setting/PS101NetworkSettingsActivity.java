...
import com.moko.ps101m.databinding.Ps101mActivityNetworkSettingBinding;
...
public class PS101NetworkSettingsActivity extends PS101BaseActivity implements RadioGroup.OnCheckedChangeListener {
    private Ps101mActivityNetworkSettingBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Ps101mActivityNetworkSettingBinding.inflate(getLayoutInflater());
            ...
            if (intent != null) {
                ...
                if (BluetoothAdapter.ACTION_STATE_CHANGED.equals(action)) {
                    ...
                    if (blueState == BluetoothAdapter.STATE_TURNING_OFF) {
                        dismissSyncProgressDialog();
                        AlertDialog.Builder builder = new AlertDialog.Builder(PS101NetworkSettingsActivity.this);
                        builder.setTitle("Dismiss");
                        builder.setCancelable(false);
                        builder.setMessage("The current system of bluetooth is not available!");
                        builder.setPositiveButton("OK", (dialog, which) -> {
                            PS101NetworkSettingsActivity.this.setResult(RESULT_OK);
                            finish();
                        });
                        builder.show();
                    }
