...
public class PS101PeriodicModeActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_PERIODIC_MODE_REPORT_INTERVAL:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101PeriodicModeActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
