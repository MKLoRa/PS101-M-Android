...
import com.moko.ps101m.adapter.PS101TimePointAdapter;
...
public class PS101TimingModeActivity extends PS101BaseActivity implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    private PS101TimePointAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new PS101TimePointAdapter(mTimePoints);
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_TIME_MODE_REPORT_TIME_POINT:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101TimingModeActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
