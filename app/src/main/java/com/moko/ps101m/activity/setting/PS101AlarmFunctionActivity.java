 ...
 * @des:
 */
public class PS101AlarmFunctionActivity extends PS101BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind.tvAlertAlarmSetting.setOnClickListener(v -> startActivity(new Intent(this, PS101AlertAlarmSettingActivity.class)));
        mBind.tvSosAlarmSetting.setOnClickListener(v -> startActivity(new Intent(this, PS101AlarmSosSettingActivity.class)));
    }
