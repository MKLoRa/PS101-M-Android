...
public class PS101FilterIBeaconActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_FILTER_IBEACON_ENABLE:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101FilterIBeaconActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
