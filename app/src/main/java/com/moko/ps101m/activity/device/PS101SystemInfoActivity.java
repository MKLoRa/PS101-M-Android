...
public class PS101SystemInfoActivity extends PS101BaseActivity {
    ...
    public void onDebuggerMode(View view) {
        ...
        Intent intent = new Intent(this, PS101LogDataActivity.class);
        intent.putExtra(AppConstants.EXTRA_KEY_DEVICE_MAC, mDeviceMac);
    ...
    private final DfuProgressListener mDfuProgressListener = new DfuProgressListenerAdapter() {
        ...
        public void onDeviceConnecting(@NonNull String deviceAddress) {
            ...
            if (mDeviceConnectCount > 3) {
                ToastUtils.showToast(PS101SystemInfoActivity.this, "Error:DFU Failed");
                dismissDFUProgressDialog();
                final LocalBroadcastManager manager = LocalBroadcastManager.getInstance(PS101SystemInfoActivity.this);
        ...
        public void onError(@NonNull String deviceAddress, int error, int errorType, String message) {
            ToastUtils.showToast(PS101SystemInfoActivity.this, "Opps!DFU Failed. Please try again!");
    ...
    public void onTest(View view) {
        if (isTriggerValid()) {
            startActivity(new Intent(this, PS101SelfTestActivity.class));
        }
    }
}
