...
public class PS101FilterRawDataSwitchActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_FILTER_BXP_DEVICE:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101FilterRawDataSwitchActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
    ...
    public void onFilterByIBeacon(View view) {
        ...
        Intent i = new Intent(this, PS101FilterIBeaconActivity.class);
        launcher.launch(i);
    }

    public void onFilterByUid(View view) {
        if (isWindowLocked()) return;
        Intent i = new Intent(this, PS101FilterUIDActivity.class);
        launcher.launch(i);
    }

    public void onFilterByUrl(View view) {
        if (isWindowLocked()) return;
        Intent i = new Intent(this, PS101FilterUrlActivity.class);
        launcher.launch(i);
    }

    public void onFilterByTlm(View view) {
        if (isWindowLocked()) return;
        Intent i = new Intent(this, PS101FilterTLMActivity.class);
        launcher.launch(i);
    }

    public void onFilterByBXPiBeacon(View view) {
        if (isWindowLocked()) return;
        Intent i = new Intent(this, PS101FilterBXPIBeaconActivity.class);
        launcher.launch(i);
    }
    ...
    public void onFilterByBXPButton(View view) {
        if (isWindowLocked()) return;
        Intent i = new Intent(this, PS101FilterBXPButtonActivity.class);
        launcher.launch(i);
    }

    public void onFilterByBXPTag(View view) {
        if (isWindowLocked()) return;
        Intent i = new Intent(this, PS101FilterBXPTagIdActivity.class);
        launcher.launch(i);
    }

    public void onFilterByMkPir(View view) {
        if (isWindowLocked()) return;
        Intent i = new Intent(this, PS101FilterMkPirActivity.class);
        launcher.launch(i);
    }

    public void onFilterByOther(View view) {
        if (isWindowLocked()) return;
        Intent i = new Intent(this, PS101FilterOtherActivity.class);
        launcher.launch(i);
    }
