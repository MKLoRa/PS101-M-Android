...
public class PS101FilterMacAddressActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_FILTER_MAC_RULES:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101FilterMacAddressActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
                                ...
                                case KEY_FILTER_MAC_RULES:
                                    if (length > 0) {
                                        ...
                                        for (int i = 0, l = filterMacAddress.size(); i < l; i++) {
                                            ...
                                            View v = LayoutInflater.from(PS101FilterMacAddressActivity.this).inflate(R.layout.ps101m_item_mac_filter, mBind.llMacAddress, false);
