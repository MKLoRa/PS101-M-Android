...
public class PS101DeviceModeActivity extends PS101BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind.tvStandbyMode.setOnClickListener(v -> {
            ...
            startActivity(new Intent(this, PS101StandbyModeActivity.class));
        });
    }
    ...
    public void onTimingMode(View view) {
        if (isWindowLocked()) return;
        startActivity(new Intent(this, PS101TimingModeActivity.class));
    }

    public void onPeriodicMode(View view) {
        if (isWindowLocked()) return;
        startActivity(new Intent(this, PS101PeriodicModeActivity.class));
    }

    public void onMotionMode(View view) {
        if (isWindowLocked()) return;
        startActivity(new Intent(this, PS101MotionModeActivity.class));
    }
}
