...
public class PS101FilterAdvNameActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_FILTER_NAME_RULES:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101FilterAdvNameActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
                                ...
                                case KEY_FILTER_NAME_RULES:
                                    if (length > 0) {
                                        ...
                                        for (int i = 0, l = filterAdvName.size(); i < l; i++) {
                                            ...
                                            View v = LayoutInflater.from(PS101FilterAdvNameActivity.this).inflate(R.layout.ps101m_item_adv_name_filter, mBind.llDavName, false);
