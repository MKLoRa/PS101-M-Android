...
public class PS101FilterUIDActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_FILTER_EDDYSTONE_UID_ENABLE:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101FilterUIDActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
