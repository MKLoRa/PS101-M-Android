...
public class PS101FilterUrlActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_FILTER_EDDYSTONE_URL_ENABLE:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101FilterUrlActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
