...
public class PS101PosGpsFixActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_GPS_PDOP_LIMIT_L76C:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101PosGpsFixActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
