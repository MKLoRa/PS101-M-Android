...
public class PS101AuxiliaryOperationActivity extends PS101BaseActivity {
    @Override
    ...
    public void onDownlinkForPos(View view) {
        if (isWindowLocked()) return;
        startActivity(new Intent(this, PS101DownlinkForPosActivity.class));
    }

    public void onManDownDetection(View view) {
        if (isWindowLocked()) return;
        startActivity(new Intent(this, PS101ManDownDetectionActivity.class));
    }

    public void onAlarmFunction(View view) {
        if (isWindowLocked()) return;
        startActivity(new Intent(this, PS101AlarmFunctionActivity.class));
    }
