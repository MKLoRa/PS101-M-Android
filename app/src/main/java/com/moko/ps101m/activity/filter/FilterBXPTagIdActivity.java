...
import com.moko.ps101m.databinding.ActivityFilterBxpTagIdBinding;
                                ...
                                case KEY_FILTER_BXP_TAG_RULES:
                                    if (length > 0) {
                                        ...
                                        for (int i = 0, l = filterTagId.size(); i < l; i++) {
                                            ...
                                            View v = LayoutInflater.from(FilterBXPTagIdActivity.this).inflate(R.layout.item_tag_id_filter, mBind.llTagId, false);
