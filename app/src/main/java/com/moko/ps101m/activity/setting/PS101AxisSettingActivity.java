...
public class PS101AxisSettingActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_ACC_MOTION_CONDITION:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101AxisSettingActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
