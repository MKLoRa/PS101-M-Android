...
import com.moko.ps101m.activity.device.PS101ExportDataActivity;
import com.moko.ps101m.activity.device.PS101IndicatorSettingsActivity;
import com.moko.ps101m.activity.device.PS101OnOffSettingsActivity;
import com.moko.ps101m.activity.device.PS101SystemInfoActivity;
import com.moko.ps101m.activity.setting.PS101AuxiliaryOperationActivity;
import com.moko.ps101m.activity.setting.PS101AxisSettingActivity;
import com.moko.ps101m.activity.setting.PS101BleSettingsActivity;
import com.moko.ps101m.activity.setting.PS101DeviceModeActivity;
...
import com.moko.ps101m.fragment.PS101DeviceFragment;
import com.moko.ps101m.fragment.PS101GeneralFragment;
import com.moko.ps101m.fragment.PS101NetworkFragment;
import com.moko.ps101m.fragment.PS101PositionFragment;
...
public class PS101DeviceInfoActivity extends PS101BaseActivity implements RadioGroup.OnCheckedChangeListener {
    private Ps101mActivityDeviceInfoBinding mBind;
    private FragmentManager fragmentManager;
    private PS101NetworkFragment networkFragment;
    private PS101PositionFragment posFragment;
    private PS101GeneralFragment generalFragment;
    private PS101DeviceFragment deviceFragment;
    ...
    private void initFragment() {
        networkFragment = PS101NetworkFragment.newInstance();
        posFragment = PS101PositionFragment.newInstance();
        generalFragment = PS101GeneralFragment.newInstance();
        deviceFragment = PS101DeviceFragment.newInstance();
            ...
            if (intent != null) {
                ...
                if (BluetoothAdapter.ACTION_STATE_CHANGED.equals(action)) {
                    ...
                    if (blueState == BluetoothAdapter.STATE_TURNING_OFF) {
                        dismissSyncProgressDialog();
                        AlertDialog.Builder builder = new AlertDialog.Builder(PS101DeviceInfoActivity.this);
                        builder.setTitle("Dismiss");
                        builder.setCancelable(false);
                        builder.setMessage("The current system of bluetooth is not available!");
                        builder.setPositiveButton("OK", (dialog, which) -> {
                            PS101DeviceInfoActivity.this.setResult(RESULT_OK);
                            finish();
                        });
                        builder.show();
                    }
    ...
    public void onWifiFix(View view) {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, PS101PosWifiFixActivity.class);
        startActivity(intent);
    }

    public void onBleFix(View view) {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, PS101PosBleFixActivity.class);
        startActivity(intent);
    }

    public void onGPSFix(View view) {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, PS101PosGpsFixActivity.class);
        startActivity(intent);
    }

    public void onDeviceMode(View view) {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, PS101DeviceModeActivity.class);
        startActivity(intent);
    }

    public void onAuxiliaryInterval(View view) {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, PS101AuxiliaryOperationActivity.class);
        startActivity(intent);
    }

    public void onBleSettings(View view) {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, PS101BleSettingsActivity.class);
        startActivity(intent);
    }

    public void onAxisSettings(View view) {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, PS101AxisSettingActivity.class);
        startActivity(intent);
    }

    public void onLocalDataSync(View view) {
        if (isWindowLocked()) return;
        startActivity(new Intent(this, PS101ExportDataActivity.class));
    }

    public void onIndicatorSettings(View view) {
        if (isWindowLocked()) return;
        startActivity(new Intent(this, PS101IndicatorSettingsActivity.class));
    }
    ...
    public void onDeviceInfo(View view) {
        if (isWindowLocked()) return;
        launcher.launch(new Intent(this, PS101SystemInfoActivity.class));
    }
    ...
    public void onOffSetting(View view) {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, PS101OnOffSettingsActivity.class);
        startActivity(intent);
    }
}
