...
public class PS101FilterTLMActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_FILTER_EDDYSTONE_TLM_ENABLE:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101FilterTLMActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
