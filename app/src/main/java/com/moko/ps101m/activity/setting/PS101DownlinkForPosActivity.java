...
public class PS101DownlinkForPosActivity extends PS101BaseActivity {
                    ...
                    if (value.length >= 4) {
                        ...
                        if (flag == 0x01) {
                            ...
                            if (configKeyEnum == ParamsKeyEnum.KEY_DOWN_LINK_POS_STRATEGY) {
                                ...
                                if (savedParamsError) {
                                    ToastUtils.showToast(PS101DownlinkForPosActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                } else {
