...
public class PS101FilterOtherActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_FILTER_OTHER_ENABLE:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101FilterOtherActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
