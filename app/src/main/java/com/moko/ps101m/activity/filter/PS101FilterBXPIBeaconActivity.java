...
public class PS101FilterBXPIBeaconActivity extends PS101BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_FILTER_BXP_IBEACON_ENABLE:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(PS101FilterBXPIBeaconActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
