...
import com.moko.ps101m.activity.setting.PS101NetworkSettingsActivity;
import com.moko.ps101m.databinding.Ps101mFragmentNetworkBinding;

public class PS101NetworkFragment extends Fragment {
    private static final String TAG = PS101NetworkFragment.class.getSimpleName();
    private Ps101mFragmentNetworkBinding mBind;

    public PS101NetworkFragment() {
    }

    public static PS101NetworkFragment newInstance() {
        return new PS101NetworkFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mBind.tvNetworkSetting.setOnClickListener(v-> startActivity(new Intent(requireActivity(), PS101NetworkSettingsActivity.class)));
