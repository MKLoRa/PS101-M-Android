...
public class PS101GeneralFragment extends Fragment {
    private static final String TAG = PS101GeneralFragment.class.getSimpleName();
    private Ps101mFragmentGeneralBinding mBind;
    public PS101GeneralFragment() {
    }

    public static PS101GeneralFragment newInstance() {
        return new PS101GeneralFragment();
    }
